            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex min-w-0 flex-1 items-center gap-[0.85rem]">
                ...
                <div className="flex flex-col gap-1">
                  <h1
                    className="m-0 leading-[1.15] font-normal tracking-wide text-crafd-yellow uppercase"
                  ...
                  {lockedSourceNode?.partner?.org_type && (
                    <p className="m-0 text-xs font-bold tracking-widest text-white/40 uppercase">
                      {lockedSourceNode.partner.org_type}
                    </p>
                  )}
                </div>
              ...
              return (
                ...
                >
                  <div className="border-l-[3px] border-crafd-yellow pl-[0.6rem]">
                    ...
                    >
                      <h3 className="m-0 flex-1 text-base leading-[1.3] font-extrabold">
                        {(() => {
                    ...
                    {(pd?.grant_size ||
                      ...
                      <div className="flex flex-wrap gap-2 pb-2">
                        {pd?.grant_size && (
                          <span className="inline-flex items-center gap-[0.3rem] rounded-md border border-white/18 bg-white/8 px-[0.55rem] py-[0.2rem] text-sm font-bold tracking-wide text-white/85">
                            {formatGrantSize(pd.grant_size)}
                          </span>
                        )}
                        {pd?.duration_months && (
                          <span className="inline-flex items-center gap-[0.3rem] rounded-md border border-white/15 bg-white/6 px-[0.55rem] py-[0.2rem] text-sm font-bold tracking-wide text-white/70">
                  ...
                  <AnimatePresence initial={false}>
                    {isProjOpen && (
                      ...
                      >
                        ...
                        >
                          {pd?.project_blurb && (
                            <p className="m-0 text-sm leading-[1.75] opacity-[0.78]">
                              {pd.project_blurb}
                            </p>
                          )}
                          ...
                          {projPartners.length > 0 &&
                            (() => {
                              ...
                              const renderPartnerList = (
                                ...
                                <p className="m-0 text-sm leading-[1.9]">
                                  {members.map((pn, pi) => (
                                    <span key={pn.id}>
                                      {pi > 0 && (
                                      ...
                                      <button
                                        ...
                                        className="cursor-pointer border-none bg-transparent p-0 font-[inherit] text-sm text-white/65 no-underline hover:text-white"
                                        onMouseEnter={(e) => {
                              ...
                              return (
                                <div className="flex flex-col gap-2">
                                  {leadPartners.length > 0 && (
                                    <div>
                                      <p className="m-0 mb-[0.2rem] text-xs font-bold tracking-widest text-white/35 uppercase">
