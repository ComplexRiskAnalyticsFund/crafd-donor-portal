...
rename_mapping = {
    ...
    '[Ecosystem Mapping] Organization Logo White PNG/SVG': "org_logo_white",
...
# df_partners.to_json(public_dir / "partners_with_logos.json", orient="records", indent=2)


# code to find logos that don't already exist in the airtable here: